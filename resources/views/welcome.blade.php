...
<div class="login-container">
    ...
    <button id="cartButton">🛒 Giỏ hàng (<span id="cartCount">0</span>)</button>
...
<div id="cartModal" class="modal">
    <div class="modal-content">
        ...
        <button id="checkout" style="margin-top: 20px";>Thanh toán</button>
    </div>
</div>
...
<script>
    ...
    async function fetchProducts() {
        try {
            ...
            document.getElementById('productList').innerHTML = "<p>Không thể tải sản phẩm!</p>";
        }
    }
    async function checkout() {
        try {
            ...
            if (error = 'fail_login') {
                alert("Bạn chưa đăng nhập, vui lòng thử lại!");
    ...
    function updateCart() {
        ...
        `).join('');
        document.getElementById('totalPrice').innerText = cart.reduce((sum, item) => sum + item.price * item.quantity, 0) + 'đ';
    }
